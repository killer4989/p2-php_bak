 ...
 * 2chAPIの SID を取得する
 *
 * @return string|false  取得できた場合はSIDを返す
 */
    function authenticate_2chapi()
    {
        ...
        if (empty($body)) {
            ...
            P2Util::pushInfoHtml('<p>p2 info: 2ちゃんねるの API を使用するには、PHPの<a href="'.
            ...
            P2Util::pushInfoHtml("<p>p2 error: 2ch API 認証に失敗しました。{$curl_msg}</p>");
            return false;
        }
